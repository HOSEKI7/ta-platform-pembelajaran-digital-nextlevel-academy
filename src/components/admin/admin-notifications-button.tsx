...
/**
 * Notifications bell for the Admin surface.
 *
 * An admin notifications backend does not exist yet. Until it does, this is a
 * self-contained, static empty-state bell — no network call, no QueryClient
 * dependency — matching the Mentor / Peserta-Magang surfaces.
 */
