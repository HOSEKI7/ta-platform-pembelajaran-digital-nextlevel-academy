...
/**
 * Notifications bell for the Mentor surface — DB-backed (mirrors the Peserta
 * Didik bell). Surfaces the mentor's feed: TASK_SUBMITTED when a mentee submits,
 * and FINAL_GRADE_OVERRIDE when an admin adjusts one of their mentees' grades
 * (PRD §6.10.1 / §6.11.9). Opening the popover marks everything read.
 */
