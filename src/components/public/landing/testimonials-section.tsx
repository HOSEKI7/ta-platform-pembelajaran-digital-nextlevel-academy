      ...
      <SiteContainer>
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-3">
          {TESTIMONIALS.map((t, idx) => (
            <figure
              key={t.name}
              className="group relative isolate flex h-full flex-col overflow-hidden rounded-3xl bg-white p-7 ring-1 ring-zinc-200/80 transition hover:-translate-y-1 hover:ring-[color:var(--color-brand-300)] hover:shadow-[0_30px_50px_-30px_rgba(35,65,137,0.35)]"
            >
