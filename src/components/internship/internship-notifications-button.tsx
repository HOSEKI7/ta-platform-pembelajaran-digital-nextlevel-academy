...
/**
 * Notifications bell for the Peserta-Magang surface.
 *
 * The student `NotificationsButton` fetches `/api/student/notifications`, which
 * is gated to `PESERTA_DIDIK` and 403s for magang users. Until a magang
 * notifications backend exists, this is a self-contained, static empty-state
 * bell — no network call, no QueryClient dependency — matching the rest of the
 * UI-only internship surface.
 */
