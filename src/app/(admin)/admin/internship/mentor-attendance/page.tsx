...
export const metadata: Metadata = {
  title: "Absensi Mentor · Admin",
  description:
    "Pantau dan koreksi kehadiran mentor magang lintas kelas pada tanggal terpilih.",
...
export default async function AdminMentorAttendancePage({
  searchParams,
}: {
  searchParams: Promise<SP>;
}) {
  await requireRole(Role.ADMINISTRATOR, {
    redirectTo: "/admin/internship/mentor-attendance",
  });
  ...
  return (
    <HydrationBoundary state={dehydrate(queryClient)}>
      <StudentPageContainer width="wide">
        <AdminAttendanceView scope="mentor" />
