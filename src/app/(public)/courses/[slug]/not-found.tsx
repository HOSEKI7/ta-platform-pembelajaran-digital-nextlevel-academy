...
export default function CourseNotFound() {
  return (
    <section className="relative isolate min-h-[calc(100svh-68px)] overflow-hidden">
      ...
      <SiteContainer className="grid place-items-center py-24">
        <div className="max-w-2xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-md text-base leading-relaxed text-zinc-600">
            Kursus yang kamu cari mungkin sudah dihapus, diarsipkan, atau alamatnya salah ketik.
            Coba kembali ke katalog kursus.
          </p>
